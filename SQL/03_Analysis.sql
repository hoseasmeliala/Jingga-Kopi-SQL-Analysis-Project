...
-- ============================================================
-- 5. MARKET PENETRATION BY CITY
-- ============================================================
---------------------------------------------------------------

-- Business Question:
-- How well is Jingga Kopi penetrating the estimated coffee
-- consumer market in each city?
--------------------------

-- Assumption:
-- 25% of the city population is estimated to consume coffee.
-- Market penetration is measured as unique customers divided
-- by the estimated coffee consumer market.
-- ============================================================
...
SELECT
	...
	population,
	unique_customers,
	ROUND(estimated_coffee_consumers / 1000, 2)
		AS estimated_coffee_consumers_thousand,
	ROUND(
		(unique_customers::NUMERIC / NULLIF(estimated_coffee_consumers, 0)) * 100,
		4
...
-- Business Rule:
-- Products with product_category = 'Coffee' are classified
-- as coffee products in this dataset.
-------------------
...
-- ============================================================
-- Q8. REVENUE VS. ESTIMATED RENT BY CITY
-- ============================================================
-- Purpose:
-- Compare cumulative revenue with estimated rental cost
-- over the same 22-month analysis period.
--
-- Revenue period : January 2024 - October 2025
-- Analysis period: 22 months
--
-- Revenue-to-Rent Ratio =
-- Cumulative Revenue /
-- (Monthly Estimated Rent × 22)
--
-- Note:
-- This ratio is a screening indicator, NOT profitability.
-- ============================================================
...
SELECT
    ...
    ci.estimated_rent AS monthly_estimated_rent,

    22 AS analysis_period_months,

    ROUND(
        (ci.estimated_rent * 22)::numeric,
        2
    ) AS estimated_rent_total_period,
...
-- ============================================================
-- 10. TOP CITIES BY REVENUE PERFORMANCE
-- ============================================================
---------------------------------------------------------------
